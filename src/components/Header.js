            ...
            <div className='header__content'>
                ...
                <div>
                    <div className='p-5 space-x-2'>
                        <a href='mailto:pradeepvarma2292@gmail.com' className='w-full py-3.5 text-xl text-center text-white transition-colors duration-300 bg-blue-400 rounded-md hover:bg-blue-500 ease px-9 md:w-auto'>Email</a>
